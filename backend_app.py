...
def create_app():
    ...
    def add_cors_headers(response):
        response.headers['Access-Control-Allow-Origin'] = 'https://daddyyyy9111.github.io'
    ...
    @app.route('/pedidos_pendentes/<order_id>', methods=['PUT', 'DELETE']) # Removido OPTIONS, pois o handler genérico cuida
